...
import com.example.co.appsiba.dao.IngreSubCateDAO;
...
public class HttpAsyncTask2 extends AsyncTask<String, Void, List> {
    ...
    public HttpAsyncTask2(String TAG, Context context) {
        this.TAG = TAG;
...
//            Log.d(TAG, "str: " + str);
            ...
            Gson gson = new Gson();
            Type listType = new TypeToken<ArrayList<IngreSubCate>>() {}.getType();
            dbList = gson.fromJson(str, listType);

//            Log.d(TAG, "dbList: " + dbList);

            new IngreSubCateDAO().insert(dbList, context);
