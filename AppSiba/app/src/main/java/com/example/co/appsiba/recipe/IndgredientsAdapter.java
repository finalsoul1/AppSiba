...
public class IndgredientsAdapter extends BaseAdapter {
    ...
    public IndgredientsAdapter(Context context, ArrayList<indgredients_item> indgredients_itemArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null) {
            ...
            indgredients_textView.setText(indgredients_itemArrayList.get(position).getIndgredients_list());
    }
