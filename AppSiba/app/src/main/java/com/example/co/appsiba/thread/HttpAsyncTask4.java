...
import com.example.co.appsiba.dao.FoodTypeDAO;
...
public class HttpAsyncTask4 extends AsyncTask<String, Void, List> {
    ...
    public HttpAsyncTask4(String TAG, Context context) {
        this.TAG = TAG;
...
//            Log.d(TAG, "dbList: " + dbList);
            ...
            new FoodTypeDAO().insert(dbList, context);
