...
public class MemoListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        if(convertView==null) {
            ...
            // memosArrayList의 position 번째 Memo 객체에서 IngredientName을 찾아서 memoINameTextView에 넣음
...
//                    Toast.makeText(context, memoIndex + " has pressed", Toast.LENGTH_LONG).show();
