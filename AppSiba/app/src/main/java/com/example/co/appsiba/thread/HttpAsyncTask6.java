...
import com.example.co.appsiba.dao.RecipeDAO;
...
public class HttpAsyncTask6 extends AsyncTask<String, Void, List> {
    ...
    public HttpAsyncTask6(String TAG, Context context) {
        this.TAG = TAG;
